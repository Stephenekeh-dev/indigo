    ...
    pub fn from_env() -> anyhow::Result<Self> {
        Ok(Self {
            ...
            database_url: std::env::var("DATABASE_URL")
                .unwrap_or_else(|_| "postgres://postgres:password@localhost:5432/indigo".into()),
            ...
            stripe_webhook_secret: std::env::var("STRIPE_WEBHOOK_SECRET")
                .unwrap_or_default(),
            zoom_account_id: std::env::var("ZOOM_ACCOUNT_ID")
                .unwrap_or_default(),
            zoom_client_id: std::env::var("ZOOM_CLIENT_ID")
                .unwrap_or_default(),
            zoom_client_secret: std::env::var("ZOOM_CLIENT_SECRET")
                .unwrap_or_default(),
