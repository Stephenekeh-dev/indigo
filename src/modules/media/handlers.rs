...
use crate::{
    ...
    utils::{slug::unique_slug, tokens::generate_secure_token,
...
pub async fn list_posts(
    ...
    let rows = sqlx::query_as!(
        ...
        r#"SELECT id, author_id, title, slug, excerpt, content,
                  ...
                  cover_image_url, tags, read_time_mins, view_count, likes_count,
...
pub async fn create_post(
    ...
    let row = sqlx::query_as!(
        Post,
        r#"INSERT INTO posts
              (id, author_id, title, slug, excerpt, content, status, category,
               tags, read_time_mins, seo_title, seo_description, published_at)
           VALUES ($1,$2,$3,$4,$5,$6,$7::post_status,$8::post_category,$9,$10,$11,$12,$13)
           RETURNING id, author_id, title, slug, excerpt, content,
                     status::text as "status!", category::text as "category!",
                     cover_image_url, tags, read_time_mins, view_count, likes_count,
                     seo_title, seo_description, published_at, created_at, updated_at"#,
        id, claims.sub, dto.title, slug, dto.excerpt, dto.content, status,
        dto.category, &tags, read_time, dto.seo_title, dto.seo_description, published_at
    )
...
pub async fn like_post(
    ...
    let inserted = sqlx::query!(
        "INSERT INTO post_likes (id, post_id, user_id)
         VALUES (uuid_generate_v4(), $1, $2) ON CONFLICT DO NOTHING",
        post_id, claims.sub
    )
...
pub async fn subscribe_newsletter(
    ...
    let existing = sqlx::query_scalar!(
        "SELECT id FROM newsletter_subscribers WHERE email = $1", dto.email
    )
    .fetch_optional(&state.db).await?;
    ...
    sqlx::query!(
        "INSERT INTO newsletter_subscribers (id, email, full_name, confirm_token, source)
        ...
        EmailPayload {
            ...
            html: format!(
                r#"<div style="font-family:sans-serif;max-width:520px;margin:auto">
                     ...
                     <p>Hi {}! Click below to confirm your Indigo newsletter subscription.</p>
                     <a href="{}" style="display:inline-block;padding:12px 28px;background:#4f46e5;
    ...
    Ok(Json(serde_json::json!({ "message": "Check your email to confirm your subscription" })))
}
...
pub async fn confirm_newsletter(
    ...
    Ok(Json(serde_json::json!({ "message": "Subscription confirmed. Welcome to Indigo!" })))
}